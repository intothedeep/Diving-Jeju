// 카카오 코드
function searchKeywordByCategory() {
  // 마커를 클릭했을 때 해당 장소의 상세정보를 보여줄 커스텀오버레이입니다
  placeOverlay = new daum.maps.CustomOverlay({
	  zIndex:1
  });
...
function displayPlaceInfo (place) {
 var content = '<div class="placeinfo">' +
                 '   <a class="title" href="' + place.placeUrl + '" target="_blank" title="' + place.place_name + '">' + place.place_name + '</a>';   
